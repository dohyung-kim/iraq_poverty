...
imgdir = '../data/chicago/Tract-835700'
...
def writeLocations(geojsonfile, tractids):
    ...
    for tract in filtered_shapes:
        ...
        boundary_locs = tract['geometry']['coordinates'][0][0] # for lacity, chicago
        print(boundary_locs)
    #     print(boundary_locs)
...
if __name__ == "__main__":
    ...
    tractids = readCensusfile(os.path.join(datadir, city, 'census_tracts.csv'))
    ...
    geojsonfile = '../data/chicago/chicago_census_tract.geojson'
