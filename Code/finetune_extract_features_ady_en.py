...
def vgg16_modified(img_rows, img_cols, channel=3):
    ...
    model.load_weights('/project/dgh-dev/UNICEF-IRAQ/code/vgg16_weights_tf_dim_ordering_tf_kernels.h5')
    ...
    model.add(ZeroPadding2D((1, 1), input_shape=input_shape)) #input_shape=input_shape
    ...
    adam = Adam(lr = 1e-3, decay=1e-6) #, momentum=0.9
...
if __name__ == '__main__':
    ...
    image_dir = '/project/dgh-dev/UNICEF-IRAQ/data'
   ...
   # sys.exit()
    ...
    checkpoint = ModelCheckpoint(filepath='/project/dgh-dev/UNICEF-IRAQ/code/predict_poverty_checkpoint.h5',
                                 monitor='val_acc',
                                 verbose=1,
                                 save_best_only=True,
                                 mode='max')
    train_data_generator = datagen.flow_from_directory(
        '/project/dgh-dev/UNICEF-IRAQ/data/train',
        target_size=(224,224),
        batch_size=4,
        class_mode='binary'
    )
    val_data_generator = datagen.flow_from_directory(
        '/project/dgh-dev/UNICEF-IRAQ/data/val',
        target_size=(224, 224),
        batch_size=4,
        class_mode='binary'
    )
    ...
    model.fit_generator(
        ...
        validation_steps=nb_val_samples // 4,
        #validation_steps=2,
    ...
    model.save_weights('/project/dgh-dev/UNICEF-IRAQ/analysis/predict_poverty_VGG16.h5')
